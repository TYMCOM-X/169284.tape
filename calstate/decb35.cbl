...
01	TO-HOLD-A-WORD		PICTURE X(70).
	...
	88 W-COMP-1        	VALUE "COMP-1".
        ...
        88 FLAG-3-CLAUSE        VALUE "SW1","SW2","SW3","SW4","SW5",
                                       "SW6","SW7","SW8","END-OF-JOB".
	88 FLAG-CLAUSE		VALUE "TODAYS-DATE", "BLOCK", "CONTAINS",
                                      "CHARACTERS", "COPY","CLASS",
		              "TODAY","DATE-WRITTEN","USER-NUMBER".
	...
	88 W-FD			VALUE "FD".
        88 W-VALID-DEVICE       VALUE "TAPE","TAPE-7","TAPE-9",
                                      "DISK","PRINTER","PUNCH",
                                      "READER".
...
START.    DISPLAY "DEC TO B-3500  COBOL PROGRAM CONVERSION AID".
...
RESTART-1.
 ...
 RESTART-2.
        DISPLAY "B35-FORMAT OUTPUT FILE NAME: " WITH NO ADVANCING.
        ACCEPT TEMPORARY-NAME.
        MOVE 0 TO I; MOVE SPACES TO PROGRAM-NAME.
        PERFORM CONVERT-ID VARYING J FROM 1 BY 1 UNTIL J > 10.
...
PROCESS-SELECT-2.
        ...
        ACCEPT THIS-WORD.
        IF NOT W-VALID-DEVICE
          DISPLAY "DISK TAPE PRINTER READER TAPE-7 TAPE-9 PUNCH...",
          GO TO PROCESS-SELECT-2.
...
*	SOURCE-COMPUTER. REPLACE PARAGRAPH WITH <B-3500.>

PROCESS-SOURCE-COMPUTER.
	PERFORM PUT-WORD.
	MOVE "B-3500." TO THIS-WORD; PERFORM PUT-WORD.
...
*	OBJECT-COMPUTER. REPLACE PARAGRAPH WITH <B-3500. SEGMENT-LIMIT IS 01.>
...
*	TODAY      .  SUBSTITUTE TODAYS-DATE AND FLAG.

PROCESS-TODAYS-DATE-PD.
	MOVE "TODAYS-DATE" TO THIS-WORD.
	PERFORM PUT-WORD.
	MOVE "*1*" TO LISTING-FLAG.
	GO TO PROCESS-PD-0.
